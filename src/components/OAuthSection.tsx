            ...
            <CardContainer className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 w-full max-w-xs sm:max-w-sm transition-transform duration-300 hover:scale-105">
                <CardBody>
                    ...
                    <CardItem>
                        <button 
                            type="button" 
                            className="text-white bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-md text-xs px-4 py-2 ml-16 flex items-center justify-center dark:focus:ring-[#1da1f2]/55 me-2 mb-2"
                        >
                            <svg 
